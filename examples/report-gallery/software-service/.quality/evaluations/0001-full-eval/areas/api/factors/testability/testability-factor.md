...
Factor: [Testability](testability-factor.md)
...
Contract tests cover every public endpoint with success and failure cases.

## Requirements

| Requirement | Rating | Status |
| --- | --- | --- |
| [contract tests cover every public endpoint](../../requirements/contract-tests-cover-public-endpoints/contract-tests-cover-public-endpoints-requirement.md) | 🔵 Target | ✅ Assessed |
...
- [data/areas/api/factors/testability/factor-analysis-result.json](../../../../data/areas/api/factors/testability/factor-analysis-result.json)
