...
Factor: [Performance](performance-factor.md)
...
Mutation p99 of 262 ms sits inside the recalibrated 300 ms target band.

## Requirements

| Requirement | Rating | Status |
| --- | --- | --- |
| [p99 mutation latency stays within budget](../../requirements/p99-latency-within-budget/p99-latency-within-budget-requirement.md) | 🔵 Target | ✅ Assessed |
