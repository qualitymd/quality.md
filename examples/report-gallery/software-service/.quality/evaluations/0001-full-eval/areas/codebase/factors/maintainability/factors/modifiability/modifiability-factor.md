...
title: "Factor: Modifiability"
---

# Factor: Modifiability
...
Factor: [Maintainability](../../maintainability-factor.md) / [Modifiability](modifiability-factor.md)
...
Recent changes remain local to owned architecture boundaries.

## Requirements

| Requirement | Rating | Status |
| --- | --- | --- |
| [architecture boundaries match the service contract](../../../../requirements/architecture-boundaries-match-the-service-contract/architecture-boundaries-match-the-service-contract-requirement.md) | 🔵 Target | ✅ Assessed |
| [changes remain local to owned architecture boundaries](../../../../requirements/changes-remain-local-to-owned-boundaries/changes-remain-local-to-owned-boundaries-requirement.md) | 🔵 Target | ✅ Assessed |
...
- [data/areas/codebase/factors/maintainability/factors/modifiability/factor-analysis-result.json](../../../../../../data/areas/codebase/factors/maintainability/factors/modifiability/factor-analysis-result.json)
