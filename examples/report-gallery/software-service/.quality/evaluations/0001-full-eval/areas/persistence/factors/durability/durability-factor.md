...
Factor: [Durability](durability-factor.md)
...
Backups restore cleanly, but rollback rehearsal recency still caps durability confidence.
...
- [data/areas/persistence/factors/durability/factor-analysis-result.json](../../../../data/areas/persistence/factors/durability/factor-analysis-result.json)
