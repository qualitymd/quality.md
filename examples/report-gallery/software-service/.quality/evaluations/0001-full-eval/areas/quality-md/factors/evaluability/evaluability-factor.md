...
Factor: [Evaluability](evaluability-factor.md)
...
Requirements are assessable from recorded evidence; the stale body context caps the shared requirement's rating.
...
- [data/areas/quality-md/factors/evaluability/factor-analysis-result.json](../../../../data/areas/quality-md/factors/evaluability/factor-analysis-result.json)
