...
title: "Factor: Containment of Action"
---

# Factor: Containment of Action
...
Factor: [Agent Harnessability](../../agent-harnessability-factor.md) / [Containment of Action](containment-of-action-factor.md)
...
Money movement and schema changes sit behind declarative approval gates.

## Requirements

| Requirement | Rating | Status |
| --- | --- | --- |
| [money-moving and schema-changing actions require human approval](../../../../requirements/consequential-actions-require-approval/consequential-actions-require-approval-requirement.md) | 🔵 Target | ✅ Assessed |
