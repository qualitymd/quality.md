...
Factor: [Agent Harnessability](../../agent-harnessability-factor.md) / [Continuity](continuity-factor.md)
...
In-flight work mostly lives in chat scrollback rather than durable progress records.

## Requirements

| Requirement | Rating | Status |
| --- | --- | --- |
| [in-flight work survives session loss through durable handoff records](../../../../requirements/handoffs-survive-session-loss/handoffs-survive-session-loss-requirement.md) | 🟡 Minimum | ✅ Assessed |
