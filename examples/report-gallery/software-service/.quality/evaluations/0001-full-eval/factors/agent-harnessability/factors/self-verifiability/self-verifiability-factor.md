...
title: "Factor: Self-Verifiability"
---

# Factor: Self-Verifiability
...
Factor: [Agent Harnessability](../../agent-harnessability-factor.md) / [Self-Verifiability](self-verifiability-factor.md)
...
The recorded sensors are deterministic and their failures carry remediation.

## Requirements

| Requirement | Rating | Status |
| --- | --- | --- |
| [recorded sensors return objective pass/fail with remediation-bearing output](../../../../requirements/sensors-return-pass-fail-with-remediation/sensors-return-pass-fail-with-remediation-requirement.md) | 🔵 Target | ✅ Assessed |
