...
func TestSetDataAndBuildEvaluationReport(t *testing.T) {
	...
	assertContains(t, string(report), "Ratings: 🔵 Target, Minimum")
...
func TestEvaluationReportNavigationHeadersAndSubjectLinks(t *testing.T) {
	...
	assertContains(t, runReport, "Ratings: 🔵 Target, 🔴 Below<br>\nConfidence: 🟢 High, 🔵 Medium, 🟡 Low, ⚪ None<br>\nEmpty: `—`")
	...
	assertContains(t, runReport, "Finding type: ✅ Strength, ⚠️ Gap, ⚠️ Risk, ❓ Unknown, ℹ️ Note<br>\nFinding severity: 🔴 Critical, 🔴 High, 🟡 Medium, 🔵 Low")
	...
	assertContains(t, rootReport, "Ratings: 🔵 Target, 🔴 Below")
