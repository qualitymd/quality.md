...
| `misplaced-root-key`       | _Area_ — a Area MUST NOT declare `ratingScale`                                                     | Flags an area that declares `ratingScale`.                                                       | No      | Repair requires deciding whether to remove, move, or reinterpret authored content. |
