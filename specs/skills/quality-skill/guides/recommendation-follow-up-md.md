...
The guide **MUST** state that recommendation follow-up is not a separate public
`/quality` workflow and is used after `/quality improve` resolves to a
compatible recommendation artifact.
