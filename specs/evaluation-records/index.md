...
Child specs for independently reviewable runtime contracts under the parent
[Evaluation records](../evaluation-records.md) spec.
...
- [log.md](log.md) - changes to this evaluation-record child-spec folder.
