...
| Command | Description |
| --- | --- |
| [`qualitymd init`](#qualitymd-init) | Scaffold a starter QUALITY.md |
| [`qualitymd lint`](#qualitymd-lint) | Validate a QUALITY.md file |
| [`qualitymd model`](#qualitymd-model) | Query a quality model's structure and canonical reference IDs |
| [`qualitymd spec`](#qualitymd-spec) | Emit the QUALITY.md format specification |
| [`qualitymd schema`](#qualitymd-schema) | Emit the companion JSON Schema for QUALITY.md frontmatter |
| [`qualitymd evaluation`](#qualitymd-evaluation) | Work with QUALITY.md evaluation runs |
| [`qualitymd version`](#qualitymd-version) | Show structured qualitymd version metadata |
| [`qualitymd update`](#qualitymd-update) | Update the qualitymd CLI through its owning install channel |
| [`qualitymd status`](#qualitymd-status) | Show a QUALITY.md workspace status snapshot |
...
| Command | Description |
| --- | --- |
| [`qualitymd model tree`](#qualitymd-model-tree) | Render the model as a containment hierarchy |
| [`qualitymd model list`](#qualitymd-model-list) | Enumerate model elements with their canonical IDs |
| [`qualitymd model get`](#qualitymd-model-get) | Show one element's detail and immediate relations |
...
| Command | Description |
| --- | --- |
| [`qualitymd evaluation create`](#qualitymd-evaluation-create) | Create a numbered evaluation run folder |
| [`qualitymd evaluation list`](#qualitymd-evaluation-list) | List evaluation runs |
| [`qualitymd evaluation status`](#qualitymd-evaluation-status) | Show whether an evaluation run is reportable |
| [`qualitymd evaluation data`](#qualitymd-evaluation-data) | Work with Evaluation structured data |
| [`qualitymd evaluation report`](#qualitymd-evaluation-report) | Build evaluation reports |
...
| Command | Description |
| --- | --- |
| [`qualitymd evaluation data set`](#qualitymd-evaluation-data-set) | Validate and persist a batch of Evaluation JSON payloads |
| [`qualitymd evaluation data list`](#qualitymd-evaluation-data-list) | List stored Evaluation JSON payloads |
| [`qualitymd evaluation data get`](#qualitymd-evaluation-data-get) | Print one stored Evaluation JSON payload |
| [`qualitymd evaluation data kinds`](#qualitymd-evaluation-data-kinds) | List Evaluation data kinds |
| [`qualitymd evaluation data example`](#qualitymd-evaluation-data-example) | Print a complete Evaluation example JSON payload |
| [`qualitymd evaluation data schema`](#qualitymd-evaluation-data-schema) | Print the Evaluation structured data JSON Schema |
| [`qualitymd evaluation data verify`](#qualitymd-evaluation-data-verify) | Validate persisted Evaluation JSON payloads |
...
| Command | Description |
| --- | --- |
| [`qualitymd evaluation report build`](#qualitymd-evaluation-report-build) | Build deterministic evaluation reports |
