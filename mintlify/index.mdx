  ...
  <div className="mt-4">
    <AccordionGroup>
      ...
      <Accordion title="What's covered by the formal QUALITY.md specification?">
        ...
        scale, naming and reference rules, evaluation semantics (how
        requirements are assessed, rated, and rolled up), report vocabulary, and
        conformance classes for files and tools. It's deliberately agent-,
        tool-, and vendor-agnostic. The [`/quality` skill](/skill) and
        [`qualitymd` CLI](/cli) are companions — a reference implementation and
        starter kit, not part of the format itself.
      </Accordion>
