...
[Versioning](https://github.com/qualitymd/quality.md/blob/main/docs/reference/versioning.md#specification-version) for the
...
[Modeling quality across domains](https://github.com/qualitymd/quality.md/blob/main/docs/guides/model-quality-across-domains.md#worked-example-a-documentation-set).
