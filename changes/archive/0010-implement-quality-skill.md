...
implementation existed yet. This change implemented it. Detail lives in the child:
...
- [Design doc](0010-implement-quality-skill/design.md) — how the change was built:
  the skill packaged for Agent Skills installation, the CLI prerequisite check in
...
- [x] [`specs/cli.md`](../../specs/cli.md), [`specs/cli/index.md`](../../specs/cli/index.md),
...
- [x] [`README.md`](../../README.md), root `install.md`, and the
      ...
      CLI.
- [x] [`specs/skills/index.md`](../../specs/skills/index.md) and
...
`Done`. See the [status lifecycle](../index.md#status-lifecycle). The implementation landed: the skill artifact, `qualitymd models` CLI surface, durable specs/docs, raw runtime example bundle, and verification are complete. The change is archived.
