...
`Done`. Implemented and archived after switching the `/quality` skill to drive the evaluation CLI for scaffolding, record writes, and reports, and replacing the inlined Artifact Contract with a reference.
