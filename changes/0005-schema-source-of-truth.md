...
rule code. The detail lives in the child:

- [Functional spec](0005-schema-source-of-truth/spec.md) — what the change must do.

A design doc follows once the spec settles.
...
- [ ] [`SPECIFICATION.md`](../SPECIFICATION.md) — point the structural-schema
      prose at the authoritative definition, reconciling any drift in favor of the
      documented format.
- [ ] [`specs/cli/lint.md`](../specs/cli/lint.md) — note that structural
